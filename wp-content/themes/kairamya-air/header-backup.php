        ...
        <div class="container border-b-blue py-3 transition-all position-relative">
            ...
            <nav class="d-lg-flex gx-5 align-items-start primaryNav" id="primaryNav">
                ...
                wp_nav_menu([
                    ...
                    'depth'          => 2,
                    'container'      => false,
                    'menu_class'     => 'navbar-nav ms-auto mb-2 mb-lg-0 gap-lg-4', // your exact ul classes
                    'add_li_class'   => 'nav-item',   // custom arg (we’ll handle below)
                    'link_class'     => 'nav-link',   // custom arg (we’ll handle below)
                ]);
                ?>
